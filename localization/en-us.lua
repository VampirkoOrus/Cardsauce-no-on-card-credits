return {
	misc = {
		...
		quips = {
			...
			chad_greeting_again = {
				"Ah, Hello again, Cloud!"
			},
			chad_greeting_unfinished = {
				"It seems I wasn't able",
				"to finish speaking with",
				"you last time!"
			},
			chad_greeting_unfinished_randAquire = {
				"It seems I wasn't able",
				"to finish speaking with",
				"you last time! No matter,",
				"I've found my way back",
				"to you by sheer luck!"
			},
			chad_congrat1 = {
				"Congratulations!",
			},
	...
	descriptions = {
		...
		VHS = {
			c_csau_blackspine = {
				name = "Black Spine",
				text = {
					"While {C:attention}playing{}, {C:attention}transforms",
			...
			c_csau_shakma = {
				name = "Shakma",
				text = {
					"While {C:attention}playing{}, always",
			...
			c_csau_troll2 = {
				name = "Troll 2",
				text = {
					"While {C:attention}playing{}, a random card",
			...
			c_csau_roar = {
				name = "Roar",
				text = {
					"While {C:attention}playing{}, do not draw",
			...
			c_csau_calibighunks = {
				...
				text = {
					"While {C:attention}playing{}, scoring {C:attention}Kings{}",
			...
			c_csau_ishtar = {
				...
				text = {
					...
					"{C:chips}+#1#{} Chips while this tape is {C:attention}playing{}",
					"{C:vhs}Running Time{}: {C:attention}#2#{} Hands"
				},
			},
			c_csau_nukie = {
			...
			c_csau_blooddebts = {
				name = "Blood Debts",
				text = {
					"While {C:attention}playing{}, gain {C:money}$#1#{} more",
			...
			c_csau_doubledown = {
				name = "Double Down",
				text = {
					"{X:mult,C:white}X#1#{} Mult While {C:attention}playing{}",
					"{C:vhs}Running Time{}: {C:attention}#2#{} Hands"
				},
			},
			c_csau_twistedpair = {
			...
			c_csau_theroom = {
				name = "The Room",
				text = {
					"While {C:attention}playing{}, reduce",
			...
			c_csau_ryansbabe = {
				name = "Ryan's Babe",
				text = {
					"While {C:attention}playing{}, scoring {C:attention}Queens{}",
			...
			c_csau_ritf = {
				...
				text = {
					"While {C:attention}playing{}, for the entirety of its",
			...
			c_csau_yoyoman = {
				...
				text = {
					"While {C:attention}playing{}, return all ",
