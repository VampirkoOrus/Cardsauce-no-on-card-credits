...
function consumInfo.loc_vars(self, info_queue, card)
    ...
    return { vars = { localize(G.GAME and G.GAME.wigsaw_suit or "Hearts", 'suits_plural'), colours = {G.C.SUITS[G.GAME and G.GAME.wigsaw_suit or "Hearts"]}}, G.GAME.probabilities.normal, card.ability.extra.prob }
end
