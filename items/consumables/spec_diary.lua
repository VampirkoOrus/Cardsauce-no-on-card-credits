...
function consumInfo.loc_vars(self, info_queue, card)
    if G.GAME.csau_unlimited_stands then
        ...
        info_queue[#info_queue+1] = {key = "csau_stand_info", set = "Other", vars = { G.GAME.modifiers.max_stands or 1, (card.area.config.collection and localize('k_csau_stand')) or (G.GAME.modifiers.max_stands > 1 and localize('b_csau_stand_cards') or localize('k_stand')) }}
    end
